...
class App extends React.Component{
  ...
  guardar(e){
    ...
    axios.post('https://cmaytag17.onrender.com/tarea',dataTarea)
    .then(res =>{
  ...
  eliminar(cod){
    axios.delete('https://cmaytag17.onrender.com/tarea/'+cod)
    .then(res=>{
  ...
  componentDidMount(){
    ...
    axios.get('https://cmaytag17.onrender.com/tarea')
    .then(res=>{
      console.log(res.data.content);
      this.setState({
